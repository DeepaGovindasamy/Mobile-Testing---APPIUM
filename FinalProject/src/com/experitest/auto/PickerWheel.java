	...
	public void testUntitled(){
		...
		// WebElement DatePickerListItem = driver.findElement(By.xpath("//*[@id='numberpicker_input' and (./preceding-sibling::* | ./following-sibling::*)[@text='98, Hour, ']]"));
			//DatePickerListItem.click();	
			 ...
			 WebElement DatePickerWheel2 = 
						driver.findElement(By.xpath("//*[@id='numberpicker_input' and (./preceding-sibling::* | ./following-sibling::*)[@text='58, Minute, ']]"));

			 JavascriptExecutor js1 = (JavascriptExecutor) driver;
			 HashMap<String, String> scrollObject2 = new HashMap<String, String>();
			 scrollObject2.put("direction", "up");
			 scrollObject2.put("element", ((RemoteWebElement) DatePickerWheel2).getId());
			 for (int i = 0; i < 4; i++) {
				 js1.executeScript("mobile: scroll", scrollObject2);
			 }
			
			 WebElement DatePickerWheel3 = 
						driver.findElement(By.xpath("//*[@id='numberpicker_input' and (./preceding-sibling::* | ./following-sibling::*)[@text='58, Second, ']]"));

			 JavascriptExecutor js2 = (JavascriptExecutor) driver;
			 HashMap<String, String> scrollObject3 = new HashMap<String, String>();
			 scrollObject3.put("direction", "up");
			 scrollObject3.put("element", ((RemoteWebElement) DatePickerWheel3).getId());
			 for (int i = 0; i < 2; i++) {
				 js2.executeScript("mobile: scroll", scrollObject3);
			 }
